...
public class OnlineAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if (Desktop.isDesktopSupported() && desktop.isSupported(Desktop.Action.BROWSE)) {
            ...
            try {
                ...
                System.out.println("error in online;url: " + url);
            }
        }
